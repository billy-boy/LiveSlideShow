...
namespace matIT.Generic.FTP
{
    public class FTPFactory
    {
        ...
        {
            get { return _strictSSL; }
            set { _strictSSL = value; }
        }
        ...
        public void getSslStream(Socket Csocket)
        {
            ...
            SslStream _sslStream = new SslStream(new NetworkStream(Csocket), false, new RemoteCertificateValidationCallback(OnCertificateValidation), null);
